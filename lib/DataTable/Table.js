    ...
    _createClass(Table, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                otherProps = _objectWithoutProperties(_props, ['className', 'columns', 'shadow', 'children', 'rowKeyColumn', 'rows', 'data', 'selectedRows']);
                ...
                _react2.default.createElement(
                    ...
                    realRows.map(function (row, idx) {
                        var _ref = row.mdlRowProps || {},
                            ...
                            mdlRowPropsOnClick = _ref.onClick,
                            remainingMdlRowProps = _objectWithoutProperties(_ref, ['className', 'onClick']);
